...
import Core.Internet.InternetClient;
...
//        OkHttpClient client = new ProxyInternet().newClient();
        ...
        InternetClient internetClient = new ProxyInternet();
        OkHttpClient client = internetClient.newClient();
...
//            System.out.println("下载完成");
            MessageBox.sendSystemInfo("下载提示", "下载完成，已开始监听！\n⌓‿⌓");
            return true;
        } catch (IOException e) {
            System.out.println("文件下载失败\n" + e);
            MessageBox.showErrorAlert("文件下载失败", "文件下载失败\n" + e);
        }
        return false;
    }
}
